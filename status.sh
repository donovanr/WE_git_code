...
# usage: run from main directory, where your in-progress modelname.snapshot file is.
...
# print the snapshot number and the weight of each particle in each bin in the most recently completed snapshot
